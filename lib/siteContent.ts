...
export const treatmentCategories: CategoryMeta[] = [
  ...
  {
    name: "관리",
    headline: "피부 컨디션 유지와 진정을 중심으로 부담 없이 시작하는 카테고리",
    description:
      "LDM, 진정관리, 홍조관리처럼 다운타임이 적고 주기적으로 받을 수 있는 관리형 시술을 모았습니다.",
    examples: "LDM, 진정관리, 홍조관리",
    audience: "다운타임이 적은 입문형 시술이나 꾸준한 유지 관리를 원하는 경우",
    accent: "emerald",
    concernTags: ["피부결·모공", "톤업/색소", "붉음증/민감"],
  },
  {
    name: "모공흉터",
